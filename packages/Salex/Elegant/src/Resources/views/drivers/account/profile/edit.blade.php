...
@section('account-content')
    <div class="account-layout">
        ...
        {!! view_render_event('bagisto.shop.driver.account.profile.edit.before', ['customer' => $driver]) !!}

        <form method="post" action="{{ route('driver.profile.store') }}" @submit.prevent="onSubmit">
            <div class="edit-form">
                @csrf

                {!! view_render_event('bagisto.shop.customers.account.profile.edit_form_controls.before', ['customer' => $driver]) !!}

                <div class="control-group" :class="[errors.has('first_name') ? 'has-error' : '']">
                    <label for="first_name" class="required">{{ __('shop::app.customer.account.profile.fname') }}</label>

                    <input type="text" class="control" name="first_name" value="{{ old('first_name') ?? $driver->first_name }}" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.fname') }}&quot;">
                ...
                <div class="control-group" :class="[errors.has('last_name') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control" name="last_name" value="{{ old('last_name') ?? $driver->last_name }}" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.lname') }}&quot;">
                ...
                <div class="control-group" :class="[errors.has('sex') ? 'has-error' : '']">
                    ...
                    <select name="gender" class="control" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.gender') }}&quot;">
                        <option value=""  @if ($driver->sex == "") selected @endif>{{ __('admin::app.customers.customers.select-gender') }}</option>
                        <option value="Other"  @if ($driver->sex == "Other") selected @endif>{{ __('shop::app.customer.account.profile.other') }}</option>
                        <option value="Male"  @if ($driver->sex == "Male") selected @endif>{{ __('shop::app.customer.account.profile.male') }}</option>
                        <option value="Female" @if ($driver->sex == "Female") selected @endif>{{ __('shop::app.customer.account.profile.female') }}</option>
                    </select>

                    <span class="control-error" v-if="errors.has('gender')">@{{ errors.first('sex') }}</span>
                </div>
                ...
                <div class="control-group"  :class="[errors.has('date_of_birth') ? 'has-error' : '']">
                    ...
                    <input type="date" class="control" name="date_of_birth" value="{{ old('date_of_birth') ?? $driver->date_of_birth }}" v-validate="" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.dob') }}&quot;">
                ...
                <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                    ...
                    <input type="email" class="control" name="email" value="{{ old('email') ?? $driver->email }}" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.email') }}&quot;">
                ...
                <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control" name="phone" value="{{ old('phone') ?? $driver->phone }}" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.phone') }}&quot;">
                ...
                {!! view_render_event('bagisto.shop.customers.account.profile.edit_form_controls.after', ['customer' => $driver]) !!}
        ...
        {!! view_render_event('bagisto.shop.customers.account.profile.edit.after', ['customer' => $driver]) !!}
    </div>
@endsection
