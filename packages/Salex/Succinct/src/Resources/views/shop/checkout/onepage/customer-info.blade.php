        ...
        <accordian :active="true" :title="'{{ __('shop::app.checkout.onepage.billing-address') }}'">
            ...
            <div slot="body">
                <div class="address-container row full-width no-margin">
                    <div :key="index" class="col-lg-4 col-md-6 address-holder pl0" v-for='(addresses, index) in this.allAddress'>
                        <div class="card">
                            <div class="card-body row">
                                <div class="col-1">
                                    <div class="radio">
                                        <input type="radio" name="billing[address_id]" :id="'billing_address_id_' + addresses.id" :value="addresses.id" v-model="address.billing.address_id" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.billing-address') }}&quot;" @change="validateForm('address-form')" />
                                ...
                                <div class="col-10">
                                    <div class="">
                                        <h5 class="card-title fw6 display-inbl" v-text="`${addresses.first_name} ${addresses.last_name}`"></h5>

                                        <i class="rango-edit-pencil"></i>
                                    </div>
                                    <p class="preview">
                                        <span v-text="addresses.address1"></span>
                                        <span v-text="addresses.city"></span>
                                        <span v-text="addresses.state"></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 address-holder pl0">
                        <div class="card">
                            <div @click="validateFormAfterAction" class="card-body add-address-button">
                                <div class="cursor-pointer" @click="window.showAddressModal()">
                ...
                <div :class="`col-12 mt15 has-error ${errors.has('address-form.billing[address_id]') ? 'has-error' : ''}`">
                    <span class="control-error" v-if="errors.has('address-form.billing[address_id]')" v-text="errors.first('address-form.billing[address_id]')">
                    </span>
                </div>
                ...
                <div class="mt10 mb10" v-if="address.billing.address_id">
                    <span class="checkbox fs16 display-inbl">
                        <input id="billing[use_for_shipping]" type="checkbox" name="billing[use_for_shipping]" v-model="address.billing.use_for_shipping" @change="validateFormAfterAction" />
                ...
                <div class="col-lg-6 address-holder pl0" v-for='(addresses, index) in this.allAddress'>
                    ...
                    <div class="card">
                        <div class="card-body row">
                            <div class="col-1">
                                <div class="radio">
                                    <input type="radio" name="shipping[address_id]" :id="'shipping_address_id_' + addresses.id" :value="addresses.id" v-model="address.shipping.address_id" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.shipping-address') }}&quot;" @change="validateForm('address-form')" />
