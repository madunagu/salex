<div class="customer-sidebar row no-margin no-padding">
    <div class="account-details col-12">
        ...
        @endif
        <div class="col-12 customer-name-text text-capitalize text-break">{{ auth('merchant')->user()->first_name . ' ' . auth('merchant')->user()->last_name}}</div>
        <div class="customer-email col-12 text-break">{{ auth('merchant')->user()->email }}</div>
    </div>
