...
<div class="account-layout">
    <div class="account-head mb-15">
        <span class="back-icon">
            <a href="{{ route('merchant.inventory_sources.index') }}"><i class="icon icon-menu-back"></i></a>
        </span>

        <span class="account-heading"> {{ __('admin::app.settings.inventory_sources.edit-title') }} </span>
    ...
    <form id="customer-address-form" method="post" action="{{ route('merchant.inventory_sources.update', $inventorySource->id) }}" @submit.prevent="onSubmit">
        <div class="account-table-content">
            ...
            <div class="button-group">
                <input class="btn btn-primary btn-lg" type="submit" value="{{ __('admin::app.settings.inventory_sources.save-btn-title') }}">
            </div>
        </div>
    </form>
