...
<div class="dashboard-card">
    <div class="title">
        ...
        <div class="data">
            ...
            <span class="progress">
                @if ($statistics['total_customers']['progress'] < 0) <span class="icon graph-down-icon"></span>
...
<div class="dashboard-card">
    ...
    <a href="{{ route('merchant.sale_orders.index') }}">
        <div class="data">
            {{ $statistics['total_orders']['current'] }}

            <span class="progress">
                @if ($statistics['total_orders']['progress'] < 0) <span class="icon graph-down-icon"></span>
            {{ __('admin::app.dashboard.decreased', [
...
<div class="dashboard-card">
    ...
    <div class="data">
        ...
        <span class="progress">
            @if ($statistics['total_sales']['progress'] < 0) <span class="icon graph-down-icon"></span>
        {{ __('admin::app.dashboard.decreased', [
...
<div class="dashboard-card">
    ...
    <div class="data">
        ...
        <span class="progress">
            @if ($statistics['avg_sales']['progress'] < 0) <span class="icon graph-down-icon"></span>
        {{ __('admin::app.dashboard.decreased', [
