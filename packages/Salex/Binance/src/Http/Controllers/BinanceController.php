...
namespace Salex\Binance\Http\Controllers;
...
class BinanceController extends Controller
{
    ...
    {
        try {
            return response()->json($this->binance->createOrder($this->buildRequestBody()));
        } catch (\Exception $e) {
    ...
    {
        try {
            $this->binance->captureOrder(request()->input('orderData.orderID'));
