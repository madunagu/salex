<div class="customer-sidebar row no-margin no-padding">
    <div class="account-details col-12">
        <div class="col-12 customer-name-text text-capitalize text-break no-padding">{{ __('succinct::app.customer.sidebar.hello') }} {{ auth('driver')->user()->first_name }}</div>
    </div>
    ...
    <ul type="none" class="navigation">
        ...
        <li>
            ...
            <a class="unset full-width" href="{{ route('driver.session.destroy') }}" onclick="event.preventDefault(); document.getElementById('driverLogout').submit();">
