...
<div class="row no-margin">
                        ...
                        <div class="right col-lg-5 col-md-5">
                            ...
                            <div class="info">
                                ...
                                <div class="row delivery-detail">
                                    ...
                                    <div class="col-lg-10"><label class="fw6 fs12">Llega: 05 de nov, 2022</label>
                                        <p class="fs12 fw3">Recibe tu producto directo hasta la pruerta de tu casa.
                                            Realiza el pedido en 02:02:01</p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <h4>Share this Product</h4>
                                    <div class="social-icons">
                                        <a href="https://facebook.com" target="_blank" class="unset" rel="noopener noreferrer"><i class="fs24 within-circle rango-facebook" title="facebook"></i> </a>
                                        <a href="https://twitter.com" target="_blank" class="unset" rel="noopener noreferrer"><i class="fs24 within-circle rango-twitter" title="twitter"></i> </a>
                                        <a href="https://linkedin.com" target="_blank" class="unset" rel="noopener noreferrer"><i class="fs24 within-circle rango-linked-in" title="linkedin"></i> </a>
                                        <a href="https://pintrest.com" target="_blank" class="unset" rel="noopener noreferrer"><i class="fs24 within-circle rango-pintrest" title="Pinterest"></i> </a>
                                        <a href="https://youtube.com" target="_blank" class="unset" rel="noopener noreferrer"><i class="fs24 within-circle rango-youtube" title="Youtube"></i> </a>
                                        <a href="https://instagram.com" target="_blank" class="unset" rel="noopener noreferrer"><i class="fs24 within-circle rango-instagram" title="instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="col-lg-2">
        ...
        <div class="seller-detail">
            ...
            <label><i class="material-icons text-down-3">shopping_cart</i>
