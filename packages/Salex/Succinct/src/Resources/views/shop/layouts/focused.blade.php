...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        @else
            <link rel="icon" sizes="16x16" href="{{ asset('/themes/succinct/assets/images/static/v-icon.png') }}" />
        @endif

        {{-- all styles --}}
        @include('succinct::layouts.styles')
    </head>
    ...
    <body @if (core()->getCurrentLocale() && core()->getCurrentLocale()->direction === 'rtl') class="rtl" @endif>
        ...
        <div id="app">
            ...
            <div class="main-container-wrapper">
                ...
                @section('body-header')
                    ...
                    @include('succinct::layouts.top-nav.index')

                    {!! view_render_event('bagisto.shop.layout.header.before') !!}

                        {{-- primary header after top nav --}}
                        @include('succinct::layouts.header.index')
                    ...
                    <div class="main-content-wrapper col-12 no-padding">
                        ...
                        <header class="row velocity-divide-page vc-header header-shadow active">
                            ...
                            <div class="vc-small-screen container">
                                @include('succinct::layouts.header.mobile')
                            </div>

                            {{-- desktop header --}}
                            @include('succinct::layouts.header.desktop')
        ...
        {{-- all scripts --}}
        @include('succinct::layouts.scripts')
    </body>
</html>
