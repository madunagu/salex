...
@section('page_title')
{{ __('driver::app.vehicles.create-title') }}
@endsection
...
<form method="POST" @submit.prevent="onSubmit" action="{{ route('driver.vehicles.update',$vehicle->id) }}" enctype="multipart/form-data">
    ...
    <div class="account-table-content">
        ...
        <div :class="`row ${errors.has('type') ? 'has-error' : ''}`">
            ...
            <div class="col-12">
                <input value="{{ old('type') }}" name="type" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('driver::app.vehicles.type') }}&quot;" />
        ...
        <div :class="`row ${errors.has('model') ? 'has-error' : ''}`">
            ...
            <div class="col-12">
                <input value="{{ old('model') }}" name="model" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('driver::app.vehicles.model') }}&quot;" />
        ...
        <div :class="`row ${errors.has('color') ? 'has-error' : ''}`">
            ...
            <div class="col-12">
                <input value="{{  old('color') }}" name="color" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('driver::app.vehicles.color') }}&quot;" />
        ...
        <div :class="`row ${errors.has('year') ? 'has-error' : ''}`">
            ...
            <div class="col-12">
                <input value="{{ old('year') }}" name="year" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('driver::app.vehicles.year') }}&quot;" />
        ...
        <div :class="`row ${errors.has('plate_no') ? 'has-error' : ''}`">
            ...
            <div class="col-12">
                <input value="{{ old('plate_no') }}" name="plate_no" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('driver::app.vehicles.plate-no') }}&quot;" />
        ...
        <div :class="`row ${errors.has('vin_no') ? 'has-error' : ''}`">
            ...
            <div class="col-12">
                <input value="{{ old('vin_no') }}" name="vin_no" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('driver::app.vehicles.vin-no') }}&quot;" />
