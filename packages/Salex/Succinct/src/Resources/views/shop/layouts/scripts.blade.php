<script type="text/javascript" src="{{ asset(mix('/js/manifest.js', 'themes/succinct/assets')) }}"></script>

<script type="text/javascript" src="{{ asset(mix('/js/succinct-core.js', 'themes/succinct/assets')) }}"></script>

<script type="text/javascript" src="{{ asset(mix('/js/components.js', 'themes/succinct/assets')) }}"></script>
