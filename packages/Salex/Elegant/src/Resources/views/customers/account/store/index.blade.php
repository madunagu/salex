...
@section('account-content')
    <div class="account-layout">
        <div class="account-head">
            ...
            @if (!empty($store))
                <span class="account-action">
                    <a href="{{ route('customer.store.update') }}">{{ __('marketplace::app.account.edit-store') }}</a>
                </span>
            @else
                <span></span>
            @endif
        ...
        <div class="account-table-content" style="width: 50%;">
                ...
                <a href="{{ route('customer.store.create') }}">{{ __('marketplace::app.account.create-store') }}</a>
            @else
