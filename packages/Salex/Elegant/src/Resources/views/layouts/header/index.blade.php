            ...
            <ul class="right-content-menu">
               ...
               @php
                ...
                <li>
                    ...
                    @php
                    $showGuest = (auth()->guard('merchant') == null && auth()->guard('driver') == null &&  auth()->guard('customer'));
                    @endphp
                    @if($showGuest) 
                    ...
                    @auth('merchant')
                        ...
                        <ul class="dropdown-list account customer">
                            <li>
                                <div>
                                    <label style="color: #9e9e9e; font-weight: 700; text-transform: uppercase; font-size: 15px;">
                                        {{ auth()->guard('merchant')->user()->first_name }}
                                    </label>
                                </div>

                                <ul>
                                    <li>
                                        <a href="{{ route('merchant.profile.index') }}">{{ __('shop::app.header.profile') }}</a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <a
                                            href="{{ route('merchant.session.destroy') }}"
                                            onclick="event.preventDefault(); document.getElementById('merchantLogout').submit();">
                                            {{ __('shop::app.header.logout') }}
                                        </a>
                                    </li>
                                </ul>
                    ...
                    @auth('driver')
                        ...
                        <ul class="dropdown-list account customer">
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('driver.profile.index') }}">{{ __('shop::app.header.profile') }}</a>
                                    </li>

                       

                                    <li>
                                        <form id="driverLogout" action="{{ route('driver.session.destroy') }}" method="POST">
                                            @csrf
                                        ...
                                        <a
                                            href="{{ route('driver.session.destroy') }}"
                                            onclick="event.preventDefault(); document.getElementById('driverLogout').submit();">
                                            {{ __('shop::app.header.logout') }}
                                        </a>
                                    </li>
                                </ul>
