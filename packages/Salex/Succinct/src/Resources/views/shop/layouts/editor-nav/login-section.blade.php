...
<div id="account">
    ...
    <div class="d-inline-block welcome-content dropdown-toggle">
        ...
        $store = app('Salex\MarketPlace\Repositories\StoreRepository')->find($store_id);
        @endphp
        <span>{{$store->name }}</span>
        <div class="border rounded">
            @if (auth()->guard('merchant')->user() && auth()->guard('merchant')->user()->image)
        ...
        <div class="dropdown-container">
            <ul type="none">
                ...
                <li>
                    ...
                    <a class="unset" href="{{ route('shop.customer.session.destroy') }}" onclick="event.preventDefault(); document.getElementById('customerLogout').submit();">
