    ...
    <div class="container-fluid advertisement-two-container">
        <div class="row">
            <a @if (isset($one)) href="{{ $one }}" @endif aria-label="Advertisement" class="col-lg-9 col-md-12 no-padding">
                <img
                    class="{{ $isLazyLoad ? 'lazyload' : '' }}"
                    @if (! $isLazyLoad) src="{{ asset('/themes/succinct/assets/images/toster.webp') }}" @endif
                    data-src="{{ asset('/themes/succinct/assets/images/toster.webp') }}" alt="" />
            </a>

            <a @if (isset($two)) href="{{ $two }}" @endif aria-label="Advertisement" class="col-lg-3 col-md-12 pr0">
                <img
                    class="{{ $isLazyLoad ? 'lazyload' : '' }}"
                    @if (! $isLazyLoad) src="{{ asset('/themes/succinct/assets/images/trimmer.webp') }}" @endif
                    data-src="{{ asset('/themes/succinct/assets/images/trimmer.webp') }}" alt="" />
            </a>
        </div>
    </div>
@endif