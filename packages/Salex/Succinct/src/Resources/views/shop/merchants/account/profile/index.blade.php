...
@section('page-detail-wrapper')
    <div class="account-head mb-0">
        ...
        <span class="account-action">
            <a href="{{ route('merchant.profile.edit') }}" class="theme-btn light unset float-right">
    ...
    <div class="account-table-content profile-page-content">
        <div class="row">
            <div class="col-lg-2">
            @if (auth('merchant')->user()->image)
            <div>
                <img style="width:100%;border-radius:50%;" src="{{ auth('merchant')->user()->image_url }}" alt="{{ auth('merchant')->user()->first_name }}"/>
            </div>
        @else
            <div class="customer-name col-12 text-uppercase">
                {{ substr(auth('merchant')->user()->first_name, 0, 1) }}
            </div>
        @endif
            </div>
            <div class="col-lg-8">
